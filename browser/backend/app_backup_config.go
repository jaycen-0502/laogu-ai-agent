...
func (a *App) backupClearBusinessTables() error {
	...
	tables := []string{"automation_processed_items", "automation_daily_counters", "automation_account_states", "launch_codes", "browser_profile_extension_settings", "browser_profile_extensions", "browser_profiles", "browser_proxies", "browser_cores", "browser_bookmarks", "browser_groups", "browser_extensions"}
