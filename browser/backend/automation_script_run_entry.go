...
func (a *App) AutomationTaskActiveList() []automation.ActiveTaskInfo {
	if a.automationMgr == nil {
		return []automation.ActiveTaskInfo{}
	}
	return a.automationMgr.ActiveTasks()
}

func (a *App) AutomationTaskStop(taskID string) error {
	if a.automationMgr == nil {
		return fmt.Errorf("automation runtime manager is not initialized")
	}
	return a.automationMgr.StopTask(taskID)
}

func (a *App) AutomationTaskStopByProfile(profileID string) int {
	if a.automationMgr == nil {
		return 0
	}
	return a.automationMgr.StopTasksByProfile(profileID)
}
