...
export namespace automationstate {
	...
	export class CounterIncrementInput {
	    profileId: string;
	    platform: string;
	    counterDate: string;
	    counterKey: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new CounterIncrementInput(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.profileId = source["profileId"];
	        this.platform = source["platform"];
	        this.counterDate = source["counterDate"];
	        this.counterKey = source["counterKey"];
	...
	export class DailyCounter {
	    ...
	    static createFrom(source: any = {}) {
	        return new DailyCounter(source);
	    }
	...
	export class ProcessedItemInput {
	    profileId: string;
	    platform: string;
	    itemType: string;
	    itemKey: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new ProcessedItemInput(source);
	    }
	...
	export class ProcessedItemStatus {
	    processed: boolean;
	    processedAt: string;
	
	    static createFrom(source: any = {}) {
	        return new ProcessedItemStatus(source);
	    }
...
export namespace offlinelicense {
	...
	export class Status {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.requestCode = source["requestCode"];
	        ...
	        this.clockRollback = source["clockRollback"];
	        this.remoteState = source["remoteState"];
	        this.lastOnlineCheckAt = source["lastOnlineCheckAt"];
	        this.offlineGraceDays = source["offlineGraceDays"];
	    }
	}
