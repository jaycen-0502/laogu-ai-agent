; Laogu Browser NSIS Installer Script
...
!define PRODUCT_NAME    "Laogu Browser"
...
!define INSTALL_DIR     "$PROGRAMFILES64\Laogu Browser"
...
!define MUI_DIRECTORYPAGE_TEXT_TOP "请选择 Laogu Browser 的安装目录。建议安装到非 C 盘的可写目录，例如 D:\software\Laogu Browser 或 E:\software\Laogu Browser；不要安装到 C 盘、Program Files 或其他受权限保护的目录。"
...
!define MUI_FINISHPAGE_RUN_TEXT "Launch Laogu Browser"
...
Section "Laogu Browser (required)" SecMain
  SectionIn RO
