...
echo "========================================"
echo "  Laogu Browser Linux Publish"
echo "========================================"
echo "Target : $TARGET"
...
<component type="desktop-application">
  ...
  <description>
    <p>Laogu Browser manages isolated browser profiles, proxy binding, and local environment configuration for multi-account workflows.</p>
...
Description: ${APP_NAME} desktop app
 ...
 Laogu Browser manages isolated browser profiles, proxy binding, and
