...
Use this when the user wants to see what Laogu Browser scripts already exist before choosing one to run.
...
- For scripts already bound to a target in Laogu Browser, prefer the minimal body and only override what the user explicitly asked to change.
