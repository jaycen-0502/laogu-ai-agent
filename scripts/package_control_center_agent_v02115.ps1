...
$version = "0.21.15"
$release = Join-Path $root "release\2026-08-27-control-center-agent-ai-reply-v0.21.15"
$payload = Join-Path $release "01-windows-portable\Laogu-Control-Center-Agent-0.21.15"
...
@(
    ...
    "AI reply control: ai_reply_ratio float 0.0/0.10/0.15/0.25"
    "Server: upgraded and health checks passed at https://api.jaycwl.org"
    "Verification: 64 targeted tests passed; web build passed; PyInstaller build passed"
