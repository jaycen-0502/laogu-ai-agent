...
$version = "0.21.17"
$release = Join-Path $root "release\2026-08-28-control-center-agent-persistent-engine-data-v0.21.17"
$payload = Join-Path $release "01-windows-portable\Laogu-Control-Center-Agent-0.21.17"
$checks = Join-Path $release "02-checksums"
$docs = Join-Path $release "03-build-record"
$zip = Join-Path $release "01-windows-portable\Laogu-Control-Center-Agent-0.21.17-windows-amd64.zip"
